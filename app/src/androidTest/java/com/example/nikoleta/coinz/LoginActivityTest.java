...
public class LoginActivityTest {
    ...
    public void loginActivityTest() {
        ...
        onView(withId(R.id.email)).perform(replaceText("test"), closeSoftKeyboard());
        ...
        onView(withId(R.id.email)).perform(replaceText("testingtests@gmail.com"));
        ...
        onView(withId(R.id.play)).check(matches(withText("Play")));
